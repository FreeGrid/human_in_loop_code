# Legacy V1/V2 workflow

Select `legacy-index.ts` explicitly to use this compatibility lifecycle. New ordinary sessions use the [readable V3 workflow](README.md).
